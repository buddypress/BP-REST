...
class BP_Test_REST_Group_Membership_Request_Endpoint extends WP_Test_REST_Controller_Testcase {
	...
	public function test_register_routes() {
		...
		// Single GET.
		$single_endpoint = $this->endpoint_url . '/(?P<request_id>[\d]+)';
	...
	public function test_create_item() {
		...
		$request = new WP_REST_Request( 'POST', $this->endpoint_url . '/' . $u );
		$request->set_query_params( array(
			'group_id' => $this->group_id,
		) );
		$request->set_param( 'context', 'view' );
	...
	public function test_create_item_invalid_member() {
		...
		$request = new WP_REST_Request( 'POST', $this->endpoint_url . '/' . REST_TESTS_IMPOSSIBLY_HIGH_NUMBER );
		$request->set_query_params( array(
			'group_id' => $this->group_id,
		) );
		$request->set_param( 'context', 'view' );
	...
	public function test_create_item_with_an_already_group_member() {
		...
		$this->assertErrorResponse( 'bp_rest_group_member_request_disallowed', $response, 500 );
	}
	...
	public function test_update_item() {
		...
		$request = new WP_REST_Request( 'PUT', $this->endpoint_url . '/' . $u );
		$request->set_query_params( array(
			'group_id' => $this->group_id,
		) );
		$request->set_param( 'context', 'view' );
	 ...
	 * @group update_item
	 */
	public function test_update_item_no_request() {
		$u = $this->factory->user->create( array( 'role' => 'subscriber' ) );
	...
	public function test_delete_item() {
		...
		$request = new WP_REST_Request( 'DELETE', $this->endpoint_url . '/' . $u );
		$request->set_query_params( array(
			'group_id' => $this->group_id,
		) );
		$request->set_param( 'context', 'view' );

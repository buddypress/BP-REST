...
class BP_REST_Attachments_Group_Avatar_Endpoint extends WP_REST_Controller {
	...
	public function register_routes() {
		register_rest_route( $this->namespace, '/' . $this->rest_base . '/(?P<group_id>[\d]+)/avatar', array(
			array(
	...
	public function get_item( $request ) {
		...
		if ( ! $avatar ) {
			return new WP_Error( 'bp_rest_attachments_group_avatar_no_image',
	...
	public function create_item( $request ) {
		...
		if ( empty( $files ) ) {
			return new WP_Error( 'bp_rest_attachments_group_avatar_no_image_file',
	...
	public function create_item_permissions_check( $request ) {
		...
		if ( true === $retval && ( bp_disable_group_avatar_uploads() || ! buddypress()->avatar->show_avatars ) ) {
			$retval = new WP_Error( 'bp_rest_attachments_group_avatar_disabled',
	...
	public function delete_item( $request ) {
		...
		if ( ! $deleted ) {
			return new WP_Error( 'bp_rest_attachments_group_avatar_delete_failed',
